...
int main()
{
    ...
    cout<<"Ingrese la cantidad de procesos(min 1, maximo 10):";
    l1:
    cin >> ver;
    if(ver>10||ver<=0){
        system("cls");
        cout<<"~~~~~~~~~~~~~~~~Error~~~~~~~~~~~~~~~~"<<endl;
        cout<<"Ingrese nuevamente la cantidad de procesos(min 1, maximo 10):";
        goto l1;
    }
    system("cls");
    for(int xa=0;xa<ver;xa=xa+1)
    {
        t1.setID(i); i++;
        t1.crearjob();
    ...
    cout<<"Integrantes:"<<endl;
      cout<<"- Rodrigo Soto"<<endl;
        cout<<"- Benjamin Castro"<<endl;
          cout<<"- Jose Aynaya"<<endl;
    cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<endl;
